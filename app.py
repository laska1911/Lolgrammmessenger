...
app.config['MAIL_USERNAME'] = 'arter33333@gmail.ru' 
app.config['MAIL_DEFAULT_SENDER'] = 'arter33333@gmail.ru' 
...
def Support():
	...
	if form.validate_on_submit():
		msg = Message(" Messenger Support", recipients=["messsupp@mail.ru"])
